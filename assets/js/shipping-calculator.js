...
/* =========================================================
   ...
   US + Canada orders with a subtotal ABOVE $500 (not
   inclusive of $500 itself) ship for free.
   Mirrors backend/ecommerce-backend/services/shippingService.js
   ========================================================= */
...
function calculateShipping(subtotal, countryCode, method = 'standard') {
  ...
  const freeShippingApplied =
    FREE_SHIPPING_COUNTRIES.includes(rule.countryCode) &&
